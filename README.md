**This python package is unofficial and is not related in any way to Haier. It can stop working at anytime!**
...
[![PyPI - License](https://img.shields.io/pypi/l/pyhOn)](https://github.com/maroneze/pyhOn/blob/main/LICENSE)
...
## Usage example
This library is used for the custom [HomeAssistant Integration "Haier hOn"](https://github.com/maroneze/hOnew).

## Contribution
Any kind of contribution is welcome!

| Please add your appliances data to our [hon-test-data collection](https://github.com/maroneze/honew-test-data). <br/>This helps us to develop new features and not to break compatibility in newer versions. |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
